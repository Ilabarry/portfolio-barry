...
const Navbar = ({ darkMode, toggleDarkMode }) => {
  ...
  const socialLinks = [
    { icon: <Linkedin className="w-4 h-4" />, href: "https://www.linkedin.com/in/ila-barry-259008343/", label: "LinkedIn", color: "hover:bg-blue-600 border-blue-200 dark:border-blue-800" },
    { icon: <Github className="w-4 h-4" />, href: "https://github.com/Ilabarry", label: "GitHub", color: "hover:bg-gray-800 border-gray-200 dark:border-gray-800" },
    { icon: <Mail className="w-4 h-4" />, href: "mailto:barryila35@gmail.com", label: "Email", color: "hover:bg-red-600 border-red-200 dark:border-red-800" },
    { icon: <MessageCirclePlus className="w-4 h-4" />, href: "https://wa.me/221783249424", label: "WhatsApp", color: "hover:bg-green-600 border-green-200 dark:border-green-800" },
  ]
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex justify-between items-center py-3 w-full overflow-hidden">
          {/* Logo */}
          <a
            href="#hero"
          ...
          >
            <div className="relative">
              <img
                src={Logo}
                alt="ILA Barry"
                className="w-10 h-10 object-contain rounded-xl transition-all duration-300 group-hover:scale-105 group-hover:shadow-md"
              />
          ...
          {/* Desktop Nav */}
          <div className="hidden xl:flex items-center space-x-1 flex-wrap">
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-gray-100 dark:border-gray-800 mt-2 pb-4 w-full px-2 overflow-hidden">
            <div className="flex flex-col space-y-1 pt-4">
              {navItems.map((item, index) => {
                ...
                return (
                  <a
                    ...
                    href={item.href}
                    onClick={() => setIsOpen(false)}
                    className={`px-3 py-3 text-sm font-medium transition-all duration-200 rounded-lg flex items-center ${
                      isActive
              ...
              <div className="px-3 pt-4">
                <p className="text-gray-500 dark:text-gray-400 text-xs mb-2 font-medium text-center">
                  Réseaux sociaux
                </p>
